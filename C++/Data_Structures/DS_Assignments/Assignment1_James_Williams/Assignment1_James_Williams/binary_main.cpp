...
int main(void)
{
	...
	//cout << "testing powerCal for 0: " << powerCal(0) << endl;
	//cout << "testing powerCal for 3: " << powerCal(3) << endl;
	//cout << "testing powerCal for 6: " << powerCal(6) << endl;
	//cout << "testing powerCal for 9: " << powerCal(9) << endl;
